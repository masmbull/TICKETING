...
class TicketSeeder extends Seeder
{
    ...
    {
        // Get users
        $staff = User::where('email', 'staff@mito.local')->first();
        $ahmad = User::where('email', 'ahmad@mito.local')->first();
        $siti  = User::where('email', 'siti@mito.local')->first();
        $budi  = User::where('email', 'budi@mito.local')->first();
        $dewi  = User::where('email', 'dewi@mito.local')->first();
        $eko   = User::where('email', 'eko@mito.local')->first();
        $fadli = User::where('email', 'fadli.maulana@mito.local')->first();
        $gita  = User::where('email', 'gita.puspita@mito.local')->first();
        $hendra = User::where('email', 'hendra.wijaya@mito.local')->first();
        $indah = User::where('email', 'indah.permata@mito.local')->first();
        $joko  = User::where('email', 'joko.susilo@mito.local')->first();
