            ...
            <div class="p-6">
                ...
                <form method="POST" action="{{ route('users.update', $user->id) }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="job_title" id="job_title" value="{{ old('job_title', $user->job_title) }}" class="input" placeholder="e.g. IT Support Specialist" />
                    </div>
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <label for="force_password_change" class="text-sm text-slate-700 dark:text-slate-300">Force password change on next login</label>
                    </div>
