...
@php
$types = [
    'info' => 'bg-blue-50 dark:bg-blue-500/15 border-blue-200 dark:border-blue-500/30 text-blue-800 dark:text-blue-300',
    'success' => 'bg-green-50 dark:bg-green-500/15 border-green-200 dark:border-green-500/30 text-green-800 dark:text-green-300',
    'warning' => 'bg-yellow-50 dark:bg-yellow-500/15 border-yellow-200 dark:border-yellow-500/30 text-yellow-800 dark:text-yellow-300',
    'danger' => 'bg-red-50 dark:bg-red-500/15 border-red-200 dark:border-red-500/30 text-red-800 dark:text-red-300',
];
$icons = [
...
<div class="rounded-lg border p-4 {{ $types[$type] }}" x-data="{ show: true }" x-show="show" x-transition>
    <div class="flex items-start">
        ...
        @if($dismissible)
            <button @click="show = false" class="ml-auto -mr-1 -mt-1 p-1 rounded-md hover:bg-white/50 dark:hover:bg-white/10 transition">
