...
@php
    $statuses = [
        'open' => 'bg-blue-50 dark:bg-blue-500/15 text-blue-700 dark:text-blue-400 ring-blue-600/20 dark:ring-blue-500/30',
        'in_progress' => 'bg-amber-50 dark:bg-amber-500/15 text-amber-700 dark:text-amber-400 ring-amber-600/20 dark:ring-amber-500/30',
        'waiting' => 'bg-purple-50 dark:bg-purple-500/15 text-purple-700 dark:text-purple-400 ring-purple-600/20 dark:ring-purple-500/30',
        'resolved' => 'bg-success-50 dark:bg-success-500/15 text-success-700 dark:text-success-400 ring-success-600/20 dark:ring-success-500/30',
        'closed' => 'bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 ring-slate-500/20 dark:ring-slate-400/30',
