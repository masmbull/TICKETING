...
@php
    $priorities = [
        'critical' => 'bg-danger-50 dark:bg-danger-500/15 text-danger-600 dark:text-danger-400 ring-danger-500/20 dark:ring-danger-500/30',
        'high' => 'bg-orange-50 dark:bg-orange-500/15 text-orange-600 dark:text-orange-400 ring-orange-500/20 dark:ring-orange-500/30',
        'medium' => 'bg-warning-50 dark:bg-warning-500/15 text-warning-600 dark:text-warning-400 ring-warning-500/20 dark:ring-warning-500/30',
        'low' => 'bg-success-50 dark:bg-success-500/15 text-success-600 dark:text-success-400 ring-success-500/20 dark:ring-success-500/30',
    ];
    $icons = [
