    ...
    @if($role === 'admin')
        ...
        <div class="grid grid-cols-3 sm:grid-cols-6 gap-2">
            <div class="stat-card flex items-center gap-3 py-3">
                <div class="stat-icon bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-400 flex-shrink-0 w-9 h-9">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
                </div>
                <div class="min-w-0">
                    <div class="text-xl font-bold text-slate-900 dark:text-white animated-counter leading-tight tabular-nums">{{ $stats['total_tickets'] }}</div>
                    <div class="text-[11px] text-slate-500 dark:text-slate-400 font-medium truncate">Total</div>
                </div>
            </div>

            <div class="stat-card flex items-center gap-3 py-3">
                <div class="stat-icon bg-primary-50 text-primary-600 dark:bg-primary-500/10 dark:text-primary-400 flex-shrink-0 w-9 h-9">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                </div>
                <div class="min-w-0">
                    <div class="text-xl font-bold text-primary-600 dark:text-primary-400 animated-counter leading-tight tabular-nums">{{ $stats['waiting_tickets'] }}</div>
                    <div class="text-[11px] text-slate-500 dark:text-slate-400 font-medium truncate">Waiting</div>
                </div>
            </div>

            <div class="stat-card flex items-center gap-3 py-3">
                <div class="stat-icon bg-warning-50 text-warning-600 dark:bg-warning-500/15 dark:text-warning-400 flex-shrink-0 w-9 h-9">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>
                </div>
                <div class="min-w-0">
                    <div class="text-xl font-bold text-warning-600 dark:text-warning-400 animated-counter leading-tight tabular-nums">{{ $stats['in_progress_tickets'] }}</div>
                    <div class="text-[11px] text-slate-500 dark:text-slate-400 font-medium truncate">In Progress</div>
                </div>
            </div>

            <div class="stat-card flex items-center gap-3 py-3">
                <div class="stat-icon bg-success-50 text-success-600 dark:bg-success-500/15 dark:text-success-400 flex-shrink-0 w-9 h-9">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                </div>
                <div class="min-w-0">
                    <div class="text-xl font-bold text-success-600 dark:text-success-400 animated-counter leading-tight tabular-nums">{{ $stats['completed_tickets'] }}</div>
                    <div class="text-[11px] text-slate-500 dark:text-slate-400 font-medium truncate">Completed</div>
                </div>
            </div>

            <div class="stat-card flex items-center gap-3 py-3">
                <div class="stat-icon bg-orange-50 text-orange-600 dark:bg-orange-500/15 dark:text-orange-400 flex-shrink-0 w-9 h-9">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                </div>
                <div class="min-w-0">
                    <div class="text-xl font-bold text-orange-600 dark:text-orange-400 animated-counter leading-tight tabular-nums">{{ $stats['unassigned_tickets'] }}</div>
                    <div class="text-[11px] text-slate-500 dark:text-slate-400 font-medium truncate">Unassigned</div>
                </div>
            </div>

            <div class="stat-card flex items-center gap-3 py-3">
                <div class="stat-icon bg-danger-50 text-danger-600 dark:bg-danger-500/15 dark:text-danger-400 flex-shrink-0 w-9 h-9">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/></svg>
                </div>
                <div class="min-w-0">
                    <div class="text-xl font-bold text-danger-600 dark:text-danger-400 animated-counter leading-tight tabular-nums">{{ $stats['sla_breach_count'] }}</div>
                    <div class="text-[11px] text-slate-500 dark:text-slate-400 font-medium truncate">SLA Breach</div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4">
            ...
            <div class="lg:col-span-2 card">
                ...
                <div class="divide-y divide-slate-50 dark:divide-slate-800">
                    ...
                    <a href="{{ route('tickets.show', $ticket->id) }}" class="flex items-center gap-3 px-4 py-2.5 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-sm text-slate-700 dark:text-slate-300 truncate">{{ \Illuminate\Support\Str::limit($ticket->description ?? '', 60) }}</p>
                        </div>
                        <div class="text-right flex-shrink-0">
                            ...
                            @else
                            <div class="text-[11px] text-orange-500 dark:text-orange-400 mt-0.5 font-medium">Unassigned</div>
                            @endif
                        </div>
                    </a>
                    @endforeach
                ...
                @else
                <div class="px-4 py-6 text-center text-sm text-slate-400 dark:text-slate-500">No tickets yet.</div>
                @endif
            </div>
            ...
            <div class="space-y-3">
                ...
                <div class="card">
                    <div class="px-4 py-2.5 border-b border-slate-100 dark:border-slate-800">
                        <h2 class="text-xs font-bold text-slate-900 dark:text-white uppercase tracking-wide">Activity</h2>
                    </div>
                    <div class="px-4 py-2.5">
                        ...
                        <div class="space-y-2.5">
                            ...
                            <div class="flex items-start gap-2.5">
                                <div class="w-1.5 h-1.5 rounded-full mt-1.5 flex-shrink-0 {{ $activity['color'] === 'green' ? 'bg-success-500' : 'bg-primary-500' }}"></div>
                                <div class="flex-1 min-w-0">
                                    <p class="text-xs text-slate-700 dark:text-slate-300 leading-relaxed">{{ $activity['message'] }}</p>
                                    <p class="text-[10px] text-slate-400 dark:text-slate-500 mt-0.5">{{ $activity['time']->diffForHumans() }}</p>
                                </div>
                            </div>
                            @endforeach
                        </div>
                        @else
                        <p class="text-xs text-slate-400 dark:text-slate-500 text-center py-2">No recent activity</p>
                        @endif
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="px-4 py-2.5 border-b border-slate-100 dark:border-slate-800">
                        <h2 class="text-xs font-bold text-slate-900 dark:text-white uppercase tracking-wide">Quick Actions</h2>
                    </div>
    ...
    @elseif($role === 'manager')
        <div class="grid grid-cols-3 sm:grid-cols-5 gap-2 mb-4">
            ...
            <div class="stat-card flex items-center gap-3 py-3">
                ...
                <div class="min-w-0">
                    <div class="text-xl font-bold text-danger-600 dark:text-danger-400 animated-counter leading-tight tabular-nums">{{ $stats['critical_tickets'] }}</div>
                    <div class="text-[11px] text-slate-500 dark:text-slate-400 font-medium truncate">Critical</div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <div class="space-y-3">
                ...
                <div class="card">
                    <div class="px-4 py-2.5 border-b border-slate-100 dark:border-slate-800">
                        <h2 class="text-xs font-bold text-slate-900 dark:text-white uppercase tracking-wide">By Status</h2>
                    </div>
                ...
                <div class="card">
                    <div class="px-4 py-2.5 border-b border-slate-100 dark:border-slate-800">
                        <h2 class="text-xs font-bold text-slate-900 dark:text-white uppercase tracking-wide">Team</h2>
                    </div>
                    <div class="px-4 py-2.5 space-y-2.5">
                        @forelse($agentPerformance as $agent)
                        <div class="flex items-center gap-2.5">
                            <div class="w-7 h-7 rounded-lg bg-gradient-to-br from-primary-500 to-purple-600 flex items-center justify-center text-white text-[10px] font-bold flex-shrink-0">{{ strtoupper(substr($agent->name, 0, 2)) }}</div>
                            <div class="flex-1 min-w-0">
                                <div class="text-sm font-semibold text-slate-900 dark:text-white truncate">{{ $agent->name }}</div>
                                <div class="text-[10px] text-slate-400 dark:text-slate-500">{{ $agent->active_count }} active</div>
                            </div>
                        </div>
                        @empty
    ...
    @elseif($role === 'staff')
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-2 mb-4">
            <div class="stat-card flex items-center gap-3 py-3">
                ...
                <div class="min-w-0">
                    <div class="text-xl font-bold text-primary-600 dark:text-primary-400 animated-counter leading-tight tabular-nums">{{ $stats['assigned_to_me'] }}</div>
                    <div class="text-[11px] text-slate-500 dark:text-slate-400 font-medium truncate">Assigned</div>
                </div>
            </div>
            <div class="stat-card flex items-center gap-3 py-3">
                <div class="stat-icon bg-warning-50 text-warning-600 dark:bg-warning-500/15 dark:text-warning-400 flex-shrink-0 w-9 h-9">
                ...
                <div class="min-w-0">
                    <div class="text-xl font-bold text-warning-600 dark:text-warning-400 animated-counter leading-tight tabular-nums">{{ $stats['in_progress_assigned'] }}</div>
                    <div class="text-[11px] text-slate-500 dark:text-slate-400 font-medium truncate">In Progress</div>
                </div>
            </div>
            <div class="stat-card flex items-center gap-3 py-3">
                ...
                <div class="min-w-0">
                    <div class="text-xl font-bold text-danger-600 dark:text-danger-400 animated-counter leading-tight tabular-nums">{{ $stats['critical_assigned'] }}</div>
                    <div class="text-[11px] text-slate-500 dark:text-slate-400 font-medium truncate">Critical</div>
                </div>
            </div>
            <div class="stat-card flex items-center gap-3 py-3">
                ...
                <div class="min-w-0">
                    <div class="text-xl font-bold text-success-600 dark:text-success-400 animated-counter leading-tight tabular-nums">{{ $stats['completed_today'] ?? 0 }}</div>
                    <div class="text-[11px] text-slate-500 dark:text-slate-400 font-medium truncate">Completed Today</div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            @else
            <div class="px-4 py-6 text-center text-sm text-slate-400 dark:text-slate-500">No assigned tickets.</div>
            @endif
        </div>
    ...
    @else
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-2 mb-4">
            <div class="stat-card flex items-center gap-3 py-3">
                ...
                <div class="min-w-0">
                    <div class="text-xl font-bold text-slate-900 dark:text-white animated-counter leading-tight tabular-nums">{{ $stats['my_total'] }}</div>
                    <div class="text-[11px] text-slate-500 dark:text-slate-400 font-medium truncate">My Tickets</div>
                </div>
            </div>
            <div class="stat-card flex items-center gap-3 py-3">
                <div class="stat-icon bg-primary-50 text-primary-600 dark:bg-primary-500/10 dark:text-primary-400 flex-shrink-0 w-9 h-9">
                ...
                <div class="min-w-0">
                    <div class="text-xl font-bold text-primary-600 dark:text-primary-400 animated-counter leading-tight tabular-nums">{{ $stats['my_waiting'] }}</div>
                    <div class="text-[11px] text-slate-500 dark:text-slate-400 font-medium truncate">Waiting</div>
                </div>
            </div>
            <div class="stat-card flex items-center gap-3 py-3">
                ...
                <div class="min-w-0">
                    <div class="text-xl font-bold text-warning-600 dark:text-warning-400 animated-counter leading-tight tabular-nums">{{ $stats['my_in_progress'] }}</div>
                    <div class="text-[11px] text-slate-500 dark:text-slate-400 font-medium truncate">In Progress</div>
                </div>
            </div>
            <div class="stat-card flex items-center gap-3 py-3">
                ...
                <div class="min-w-0">
                    <div class="text-xl font-bold text-success-600 dark:text-success-400 animated-counter leading-tight tabular-nums">{{ $stats['my_completed'] }}</div>
                    <div class="text-[11px] text-slate-500 dark:text-slate-400 font-medium truncate">Completed</div>
                </div>
            </div>
        </div>
