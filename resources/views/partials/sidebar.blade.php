...
<aside class="fixed top-0 left-0 z-40 h-screen border-r border-slate-200/60 bg-white flex flex-col transition-all duration-300 ease-out"
       ...
       @endif
       style="box-shadow: 1px 0 3px rgba(0,0,0,.02);">

    {{-- Logo --}}
    <div class="flex items-center h-16 px-4 border-b border-slate-100 flex-shrink-0">
        <a href="{{ route('dashboard') }}" class="flex items-center gap-3 group">
            <div class="w-9 h-9 rounded-xl bg-gradient-to-br from-primary-500 to-primary-700 flex items-center justify-center shadow-md shadow-primary-500/20 transition-all duration-300 group-hover:shadow-lg group-hover:shadow-primary-500/30 group-hover:scale-105">
    ...
    <button @click="sidebarOpen = !sidebarOpen" class="hidden lg:flex absolute -right-3 top-[72px] z-50 w-6 h-6 bg-white border border-slate-200 rounded-full items-center justify-center shadow-sm hover:shadow-md hover:scale-110 active:scale-95 transition-all duration-200">
        <svg class="w-3 h-3 text-slate-500 transition-transform duration-300" :class="sidebarOpen ? '' : 'rotate-180'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1 sidebar-scroll">
        ...
        <div x-data="{ open: true }">
            <button @click="open = !open" class="w-full flex items-center justify-between px-3 py-1.5" :class="sidebarOpen ? '' : 'justify-center'">
                ...
                <svg class="w-3 h-3 text-slate-400 transition-transform duration-200" :class="open ? 'rotate-0' : '-rotate-90'" x-show="sidebarOpen" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
            </button>
            <div x-show="open || !sidebarOpen" x-collapse x-cloak>
                <a href="{{ route('dashboard') }}" class="sidebar-item {{ request()->routeIs('dashboard') ? 'active' : '' }}" title="Dashboard">
                    <svg class="sidebar-icon w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-4 0a1 1 0 01-1-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 01-1 1h-2z"/></svg>
                    <span x-show="sidebarOpen" x-transition.opacity.duration.200ms class="whitespace-nowrap">Dashboard</span>
                </a>
                <a href="{{ route('tickets.index') }}" class="sidebar-item {{ request()->routeIs('tickets.*') ? 'active' : '' }}" title="All Tickets">
                    <svg class="sidebar-icon w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/></svg>
                    <span x-show="sidebarOpen" x-transition.opacity.duration.200ms class="whitespace-nowrap">All Tickets</span>
                </a>
                <a href="{{ route('users.index') }}" class="sidebar-item {{ request()->routeIs('users.*') ? 'active' : '' }}" title="Users">
                    <svg class="sidebar-icon w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
                    <span x-show="sidebarOpen" x-transition.opacity.duration.200ms class="whitespace-nowrap">Users</span>
                </a>
                <a href="{{ route('categories.index') }}" class="sidebar-item {{ request()->routeIs('categories.*') ? 'active' : '' }}" title="Categories">
                ...
                <a href="{{ route('sla-policies.index') }}" class="sidebar-item {{ request()->routeIs('sla-policies.*') ? 'active' : '' }}" title="SLA Policies">
                    <svg class="sidebar-icon w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
        ...
        <div x-data="{ open: true }">
            ...
            <div x-show="open || !sidebarOpen" x-collapse x-cloak>
                ...
                <a href="{{ route('tickets.index', ['assignee' => 'me']) }}" class="sidebar-item {{ request()->query('assignee') == 'me' && request()->routeIs('tickets.*') ? 'active' : '' }}" title="Assigned to Me">
                    <svg class="sidebar-icon w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                    <span x-show="sidebarOpen" x-transition.opacity.duration.200ms class="whitespace-nowrap">Assigned to Me</span>
                </a>
                <a href="{{ route('tickets.create') }}" class="sidebar-item {{ request()->routeIs('tickets.create') ? 'active' : '' }}" title="Create Ticket">
                    <svg class="sidebar-icon w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M12 4v16m8-8H4"/></svg>
        ...
        <div x-data="{ open: true }">
            ...
            <div x-show="open || !sidebarOpen" x-collapse x-cloak>
                ...
                <a href="{{ route('tickets.index') }}" class="sidebar-item {{ request()->routeIs('tickets.index') && !request()->query('assignee') ? 'active' : '' }}" title="My Tickets">
                    <svg class="sidebar-icon w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/></svg>
    ...
    <div class="border-t border-slate-100 p-3 flex-shrink-0">
        <div class="flex items-center gap-3 {{ sidebarOpen ? 'px-2 py-2' : 'justify-center px-0 py-2' }} rounded-xl hover:bg-slate-50 transition-all duration-200 cursor-pointer group"
            ...
            <svg class="w-4 h-4 text-slate-400 transition-transform duration-200" :class="open ? 'rotate-180' : ''" x-show="sidebarOpen" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
        </div>
        {{-- Dropdown --}}
        <div x-show="open" x-transition:enter="dropdown-enter" x-transition:leave="dropdown-leave" x-cloak
             class="mt-2 {{ sidebarOpen ? '' : 'absolute left-20 bottom-4 w-48' }} bg-white border border-slate-200 rounded-xl shadow-xl shadow-slate-200/50 overflow-hidden">
