...
<aside class="sidebar z-40"
    ...
    {{-- Logo --}}
    <div class="flex items-center h-16 px-4 border-b border-slate-100 dark:border-slate-800 flex-shrink-0">
        <a href="{{ route('dashboard') }}" class="flex items-center gap-3 group">
            ...
            <div class="overflow-hidden transition-all duration-200" :class="sidebarOpen ? 'opacity-100 w-auto' : 'opacity-0 w-0'">
                <div class="text-sm font-bold text-slate-900 dark:text-white whitespace-nowrap tracking-tight">MITO</div>
                <div class="text-[10px] font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-[0.15em] whitespace-nowrap">Helpdesk</div>
            </div>
        </a>
    </div>

    {{-- Toggle button --}}
    <button @click="sidebarOpen = !sidebarOpen" class="hidden lg:flex absolute -right-3 top-[72px] z-50 w-6 h-6 bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-full items-center justify-center shadow-sm hover:shadow-md hover:scale-110 active:scale-95 transition-all duration-200">
        <svg class="w-3 h-3 text-slate-500 dark:text-slate-300 transition-transform duration-200" :class="sidebarOpen ? '' : 'rotate-180'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {{-- Footer --}}
    <div class="border-t border-slate-100 dark:border-slate-800 p-3 flex-shrink-0">
        <div class="flex items-center gap-2.5 px-2 py-2">
            <div class="w-2 h-2 rounded-full bg-success-500 animate-pulse"></div>
            <div class="overflow-hidden transition-all duration-200" :class="sidebarOpen ? 'opacity-100 w-auto' : 'opacity-0 w-0'">
                <div class="text-xs font-medium text-slate-500 dark:text-slate-400 whitespace-nowrap">MITO Ticketing System</div>
                <div class="text-[10px] text-slate-400 dark:text-slate-500 whitespace-nowrap">Version 1.0.0</div>
            </div>
        </div>
    </div>
</aside>
