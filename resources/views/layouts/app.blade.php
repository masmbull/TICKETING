...
<body class="bg-slate-50 min-h-screen font-sans text-slate-800" x-data="{ sidebarOpen: true, mobileSidebar: false }">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 flex flex-col min-h-screen transition-all duration-200 ease-out"
    ...
    <div x-show="mobileSidebar" x-transition:enter="transition-opacity duration-200 ease-out" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition-opacity duration-150 ease-in" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0"
